    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative min-h-screen pt-24 pb-16 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          {/* Dashboard below (como la imagen) */}
          <div className="mt-12 animate-fade-in-up delay-300">
            <div className="relative w-full max-w-7xl mx-auto">
              {/* Alto controlado para que NO ocupe todo el hero */}
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="text-[11px] px-2 py-1 rounded-full border border-border/60 bg-background/20 text-muted-foreground">
                        Incluido
                      </span>
                    </div>
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  Uruguay. Con un equipo de expertos apasionados por la innovación, entregamos soluciones integrales en
                  ciberseguridad, infraestructura, cloud y desarrollo web.
                </p>
                <p>
